...
Для роботи з продуктовими вимогами або розбіжностями між джерелами дивись ієрархію та таблицю відповідності у [`00_source-of-truth_ua.md`](./00_source-of-truth_ua.md). Для технічної зміни обирай документи відповідного розділу нижче.
...
### Історичний Release Status — 2026-06-05

Це зафіксований зріз, а не підтвердження стану поточного релізу. Для актуального стану перевіряйте код, результати CI та потрібне середовище.
