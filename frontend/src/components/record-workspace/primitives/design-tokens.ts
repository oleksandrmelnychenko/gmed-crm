...
export const inputClass = cn(tokens.control.inputHeight, "rounded-lg bg-field");
export const selectClass =
  "h-9 w-full rounded-lg border border-input bg-field px-3 text-sm text-foreground outline-none transition focus:border-ring focus:ring-2 focus:ring-ring/30";
export const textareaClass =
  "min-h-[80px] w-full rounded-lg border border-input bg-field px-3 py-2 text-sm text-foreground outline-none transition focus:border-ring focus:ring-2 focus:ring-ring/30";
