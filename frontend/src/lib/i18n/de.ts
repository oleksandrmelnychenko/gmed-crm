...
export const de: Translations = {
  ...
  services_description:
    "Fordern Sie Reise-, Hotel-, Transfer- oder andere Concierge-UnterstГјtzung an und verfolgen Sie die Bearbeitung durch das Betreuungsteam.",
  ...
  services_history_description:
    "Portal-Anfragen und Concierge-Services, die bereits fГјr Ihren Fall organisiert wurden.",
  ...
  services_request_description:
    "Senden Sie einen Concierge-Bedarf direkt aus dem Portal. Das zustГ¤ndige Team prГјft die Anfrage und bucht operativ.",
  ...
  services_type_translation_support: "SprachunterstГјtzung",
  services_type_other: "Sonstiges",
  services_form_title: "Titel",
  services_form_title_placeholder: "HotelГјbernachtung am Flughafen",
  ...
  services_form_budget: "GeschГ¤tztes Budget (EUR)",
  services_form_notes: "Notizen",
  services_form_notes_placeholder:
    "Ankunftsdetails, GepГ¤ck, HotelwГјnsche, VIP-Kontext...",
