...
export const de = {
  ...
  nav_sales_people: "CV-Bibliothek",
  ...
  sales_people_title: "CV-Bibliothek",
  sales_people_subtitle:
    "Tabellarisches Sales-Register mit aufklappbarem CV-Baum pro Person.",
  sales_people_search_placeholder: "Nach Name, Markt, Sprache oder Owner suchen",
  sales_people_status_all: "Alle Status",
  sales_people_table_person: "Person",
  sales_people_table_role: "Profil",
  sales_people_table_location: "Standort",
  sales_people_table_languages: "Sprachen",
  sales_people_table_owner: "Owner",
  sales_people_table_updated: "Aktualisiert",
  sales_people_table_status: "Status",
  sales_people_empty_title: "Keine CVs gefunden",
  sales_people_empty_description:
    "Suche oder Statusfilter anpassen, um wieder Einträge in der Tabelle zu sehen.",
  sales_people_expand_cv: "CV aufklappen",
  sales_people_collapse_cv: "CV zuklappen",
  sales_people_tree_expand: "Ast aufklappen",
  sales_people_tree_collapse: "Ast zuklappen",
  sales_people_cv_tree: "CV-Baum",
  sales_people_stat_total: "CVs gesamt",
  sales_people_stat_ready: "Bereit",
  sales_people_stat_review: "In Prüfung",
  sales_people_stat_cities: "Standorte",
  sales_people_status_ready: "Bereit",
  sales_people_status_review: "Prüfung",
  sales_people_status_draft: "Entwurf",
  sales_people_status_archived: "Archiv",
