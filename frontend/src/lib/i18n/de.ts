...
export const de = {
  ...
  login_totp_title: "Anmeldung bestätigen",
  login_totp_hint: "Geben Sie den Code aus der Authenticator-App auf Ihrem Telefon ein.",
  ...
  settings_agency_data_controller_statement:
    "Verantwortlicher für die Datenverarbeitung (Dokumenttext)",
  ...
  activity_subtitle: "Relevante Aktionen, Datenänderungen und Sicherheitsereignisse",
  ...
  activity_action_login_success: "Erfolgreiche Anmeldung",
  activity_action_login_failure: "Fehlgeschlagene Anmeldung",
  activity_action_login_blocked: "Anmeldung blockiert",
  activity_action_login_mfa_requested: "Anmeldebestätigung angefordert",
  activity_action_refresh_family_revoked: "Sitzung bereits widerrufen",
  activity_action_preview_medication_evidence_review: "Vorschau des Evidenzpakets geöffnet",
  activity_action_create_medication_evidence_review: "Evidenzpaket erstellt",
  activity_action_read_medication_evidence_review: "Evidenzpaket geöffnet",
  activity_action_medication_evidence_review_created: "Evidenzpaket erstellt",
  activity_action_create_medication_ai_analysis: "KI-Entwurf angefordert",
  activity_action_read_medication_ai_analysis: "KI-Entwurf geöffnet",
  activity_action_retry_medication_ai_analysis: "KI-Entwurf erneut gestartet",
  activity_action_medication_ai_analysis_requested: "KI-Entwurf eingereiht",
  activity_action_medication_ai_analysis_ready: "KI-Entwurf bereit",
  activity_action_medication_ai_analysis_failed: "KI-Entwurf fehlgeschlagen",
  activity_anonymous_actor: "Nicht angemeldete Anfrage",
  activity_view_activity: "Aktivitäten",
  activity_view_security: "Sicherheit",
  activity_view_technical: "Technisch",
  ...
  activity_metric_security_24h: "Sicherheitsereignisse",
  activity_retention: "Automatische Bereinigung",
  activity_retention_technical: "technisch",
  activity_retention_meaningful: "relevant",
  activity_http_request: "Technische Anfrage",
  activity_entity_http: "API",
  activity_search_placeholder: "Benutzer, Aktion, Objekt oder ID...",
  activity_no_events: "Für die gewählten Filter gibt es keine Ereignisse.",
  activity_technical_route: "Route",
  activity_technical_status: "Status",
  activity_technical_latency: "Antwortzeit",
  common_ip: "IP",
  common_device: "Gerät",
  ...
  compliance_request_type_access: "Auskunft (Art. 15)",
  compliance_request_type_rectification: "Berichtigung (Art. 16)",
  compliance_request_type_portability: "Datenübertragbarkeit (Art. 20)",
  compliance_request_type_objection: "Widerspruch (Art. 21)",
  compliance_steps_title: "Bearbeitungsschritte (Art. 12 DSGVO)",
  compliance_steps_identity: "Identität der antragstellenden Person",
  compliance_steps_identity_confirm: "Als geprüft vermerken",
  compliance_steps_extension: "Fristverlängerung",
  compliance_steps_extension_hint: "einmalig um zwei Monate, nur mit Begründung",
  compliance_steps_extension_reason: "Begründung für die betroffene Person",
  compliance_steps_extension_confirm: "Frist verlängern",
  compliance_steps_notified: "Betroffene Person informiert",
  compliance_steps_notified_confirm: "Mitteilung vermerken",
  compliance_steps_done: "erledigt",
  compliance_steps_open: "offen",
  compliance_steps_method_id_document: "Ausweisdokument",
  compliance_steps_method_callback: "Rückruf unter bekannter Nummer",
  compliance_steps_method_signed_letter: "Unterschriebenes Schreiben",
  compliance_steps_method_in_person: "Persönlich",
  compliance_steps_method_portal_login: "Anmeldung im Portal",
  compliance_steps_channel_email: "E-Mail",
  compliance_steps_channel_portal: "Portal",
  compliance_steps_channel_postal_mail: "Brief",
  compliance_steps_channel_phone: "Telefon",
  compliance_steps_channel_in_person: "Persönlich",
  compliance_steps_recipients: "Empfänger informiert (Art. 19)",
  compliance_steps_recipients_hint: "Kliniken und weitere Empfänger über Berichtigung, Löschung oder Einschränkung unterrichten",
  compliance_steps_recipients_note: "Wer wurde informiert?",
  compliance_steps_recipients_confirm: "Empfänger-Mitteilung vermerken",
  ...
  invoices_workspace_dunning_description: "Verlauf der Zahlungserinnerungen und der Übergabe an das Inkasso.",
  invoices_workspace_dunning_history: "Mahnverlauf",
  invoices_workspace_dunning_action: "Nächster Schritt",
  invoices_workspace_dunning_sent_at: "Datum",
  ...
  invoices_workspace_dunning_missing_due_date: "Tragen Sie das Zahlungsziel ein, um die Fälligkeit zu prüfen.",
  invoices_workspace_dunning_not_overdue: "Das Zahlungsziel ist noch nicht überschritten. Eine Mahnung ist ab dem Folgetag möglich.",
  invoices_workspace_dunning_changed: "Der Mahnverlauf hat sich geändert. Aktualisieren Sie die Rechnung, um den nächsten verfügbaren Schritt zu sehen.",
  invoices_workspace_dunning_save_error: "Der Eintrag konnte nicht hinzugefügt werden. Aktualisieren Sie die Rechnung und prüfen Sie den Verlauf vor einem erneuten Versuch.",
  ...
  invoices_workspace_next_escalation: "Zahlung nachverfolgen",
  invoices_workspace_completed: "Abgeschlossen",
  invoices_workspace_balance_prefix: "Saldo",
  invoices_workspace_dunning_note: "Interne Notiz",
  invoices_workspace_dunning_placeholder: "Notiz für die Buchhaltung; wird nicht an den Kunden gesendet",
  invoices_workspace_no_further_escalation: "Alle Schritte sind bereits erfasst",
  ...
  documents_source_clinical_import: "Import eines medizinischen Dokuments",
