...
export interface Translations
  ...
  users_one_time_password_mode: string;
  users_one_time_password_mode_hint: string;
  users_manual_password_mode: string;
  users_one_time_password_title: string;
  users_one_time_password_shown_once: string;
  users_copy_password: string;
  users_copied: string;
  users_created_title: string;
  users_done: string;
  users_generate_one_time_password: string;
  users_generate_one_time_password_confirm: string;
  users_password_reset_required_badge: string;
  users_totp: string;
  users_totp_enrolled: string;
  users_totp_missing: string;
  users_last_login: string;
  users_never_logged_in: string;
  users_sessions: string;
  users_revoke_sessions: string;
  users_revoke_sessions_confirm: string;
  users_sessions_revoked: string;
  users_locked_until: string;
  ...
  activity_action_login_success: string;
  activity_action_login_failure: string;
  ...
  activity_view_technical: string;
  activity_view_activity_hint: string;
  activity_view_security_hint: string;
  activity_view_technical_hint: string;
  activity_view_access: string;
  activity_view_access_hint: string;
  activity_metric_events_24h: string;
  activity_metric_users_24h: string;
  activity_metric_changes_24h: string;
  activity_metric_security_24h: string;
  activity_retention: string;
  activity_retention_technical: string;
  activity_retention_meaningful: string;
  activity_http_request: string;
  activity_entity_http: string;
  activity_search_placeholder: string;
  activity_no_events: string;
  activity_technical_route: string;
  activity_technical_status: string;
  activity_technical_latency: string;
  common_ip: string;
  ...
  compliance_request_type_access: string;
  compliance_request_type_rectification: string;
  compliance_request_type_portability: string;
  compliance_request_type_objection: string;
  compliance_steps_title: string;
  compliance_steps_identity: string;
  compliance_steps_identity_confirm: string;
  compliance_steps_extension: string;
  compliance_steps_extension_hint: string;
  compliance_steps_extension_reason: string;
  compliance_steps_extension_confirm: string;
  compliance_steps_notified: string;
  compliance_steps_notified_confirm: string;
  compliance_steps_done: string;
  compliance_steps_open: string;
  compliance_steps_method_id_document: string;
  compliance_steps_method_callback: string;
  compliance_steps_method_signed_letter: string;
  compliance_steps_method_in_person: string;
  compliance_steps_method_portal_login: string;
  compliance_steps_channel_email: string;
  compliance_steps_channel_portal: string;
