...
export const ru = {
  ...
  invoices_workspace_dunning_title: "Взыскания",
  invoices_workspace_dunning_description: "История первой, второй и коллекторской эскалации по просрочке.",
  invoices_workspace_dunning_history: "История напоминаний",
  invoices_workspace_dunning_action: "Следующий шаг",
  invoices_workspace_dunning_sent_at: "Отправлено",
  invoices_workspace_dunning_responsible: "Ответственный",
  invoices_workspace_dunning_balance_due: "Сумма к взысканию",
  invoices_workspace_create_dunning: "Создать взыскание",
  ...
  invoices_workspace_next_escalation: "Следующая эскалация",
  invoices_workspace_completed: "Завершено",
  invoices_workspace_balance_prefix: "Баланс",
  invoices_workspace_dunning_note: "Примечание по просрочке",
  invoices_workspace_dunning_placeholder: "Текст напоминания или внутренняя заметка бухгалтерии",
  invoices_workspace_no_further_escalation: "Дальнейшая эскалация не требуется",
  ...
  invoices_workspace_dunning_level_collections: "Коллекторы",
