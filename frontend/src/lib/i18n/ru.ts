...
export const ru = {
  ...
  users_name: "Имя",
  users_name_placeholder: "Макс Мюллер",
  ...
  users_password_reset_success:
    "Пароль изменён. Блокировка снята, активные сессии завершены; при следующем входе пользователь должен задать новый пароль.",
  users_password_reset_confirm:
    "Новый пароль начнёт действовать сразу. Пользователь выйдет из аккаунта на всех устройствах, блокировка входа будет снята, а при следующем входе он должен будет задать свой пароль.",
  users_empty_no_results: "Нет результатов",
  users_empty_no_users: "Нет пользователей",
  users_one_time_password_mode: "Одноразовый пароль (сгенерирует сервер)",
  users_one_time_password_mode_hint:
    "Пароль будет показан один раз — передайте его пользователю лично. При первом входе он обязан задать свой пароль. Письма не отправляются.",
  users_manual_password_mode: "Задать пароль вручную",
  users_one_time_password_title: "Одноразовый пароль",
  users_one_time_password_shown_once:
    "Показывается только сейчас. Скопируйте и передайте пользователю лично — после закрытия окна пароль недоступен.",
  users_copy_password: "Скопировать",
  users_copied: "Скопировано",
  users_created_title: "Пользователь создан",
  users_done: "Готово",
  users_generate_one_time_password: "Сгенерировать одноразовый пароль",
  users_generate_one_time_password_confirm:
    "Сервер создаст новый одноразовый пароль и покажет его один раз. Пользователь выйдет из аккаунта на всех устройствах, блокировка входа будет снята, а при следующем входе он должен будет задать свой пароль.",
  users_password_reset_required_badge: "Смена пароля при входе",
  users_totp: "Аутентификатор",
  users_totp_enrolled: "Подключён",
  users_totp_missing: "Не подключён",
  users_last_login: "Последний вход",
  users_never_logged_in: "Ещё не входил",
  users_sessions: "Сессии",
  users_revoke_sessions: "Завершить сессии",
  users_revoke_sessions_confirm:
    "Все активные сессии пользователя будут завершены; ему придётся войти заново.",
  users_sessions_revoked: "Сессии завершены",
  users_locked_until: "Заблокирован до",
  users_last_ceo_protected:
    "Нельзя деактивировать или понизить последний активный аккаунт CEO.",
  users_ceo_managed_by_ceo_only: "Аккаунты CEO может изменять только CEO.",
  users_cannot_deactivate_self: "Нельзя деактивировать собственный аккаунт.",

  role_ceo: "Генеральный директор",
  role_ceo_assistant: "Ассистент директора",
  role_patient_manager: "Менеджер пациентов",
  role_teamlead_interpreter: "Тимлид сотрудников",
  role_interpreter: "Сотрудник",
  ...
  cabinet_eyebrow_default: "Рабочее место",
  cabinet_subtitle_default: "Для вашей роли пока не настроен кабинет. Доступны только общие разделы.",
  cabinet_subtitle_ceo_assistant:
    "Кабинет ассистента: задачи, сроки руководителя и данные для просмотра без права изменений.",
  cabinet_subtitle_patient_manager:
    "Кабинет менеджера пациентов: свои пациенты, лиды, заказы и контракты.",
  cabinet_subtitle_teamlead_interpreter:
    "Кабинет тимлида: планирование сотрудников, документы и подтверждение часов.",
  cabinet_subtitle_interpreter:
    "Кабинет сотрудника: свои приёмы, документы, задачи и учёт часов.",
  cabinet_subtitle_concierge:
    "Кабинет консьержа: сервисы, отели, приёмы и сервисная сетка лидов.",
  cabinet_subtitle_billing:
    "Кабинет бухгалтерии: счета, заказы, финансы компании и контракты.",
  cabinet_subtitle_sales:
    "Кабинет продаж: лиды, партнёры, рыночная аналитика и чат.",
  cabinet_subtitle_it_admin:
    "Технический кабинет: пользователи, безопасность, настройки и состояние системы. Без данных пациентов.",
  cabinet_module_hours: "Часы и отчёты",
  cabinet_quick_links_empty: "Для вашей роли нет разрешённых рабочих разделов.",
  ...
  access_audit_note: "Заметка аудита",
  ...
  common_no: "Нет",
  common_search: "Поиск...",
  common_search_placeholder: "Поиск...",
  common_select_placeholder: "Выберите значение",
  common_no_results: "Нет результатов",
  common_clear: "Очистить",
  common_remove: "Удалить",
  common_value: "Значение",
  common_actions: "Действия",
  common_unknown_value: "Неизвестное значение",
  enum_unknown: "Неизвестно",
  select_missing_value: "Значение недоступно",
  ...
  table_filter_no_fields: "Нет доступных полей",
  table_filter_remove: "Удалить фильтр",
  table_sort_add: "Добавить сортировку",
  table_sort_clear: "Очистить",
  table_sort_none: "Без сортировки",
  table_sort_ascending: "По возрастанию",
  table_sort_descending: "По убыванию",
  table_sort_move_up: "Выше",
  table_sort_move_down: "Ниже",
  table_sort_remove: "Удалить сортировку",
  table_columns: "Колонки",
  table_columns_search: "Поиск колонок",
  table_columns_show_all: "Показать все",
  table_columns_hide_all: "Скрыть все",
  table_columns_required: "обязательная",
  table_columns_freeze: "Закрепить",
  table_columns_unfreeze: "Открепить",
  table_columns_frozen: "закреплена",
  table_columns_freeze_limit: "Лимит закрепленных колонок",
  table_select_all: "Выбрать все",
  table_select_row: "Выбрать строку",
  table_resize_column: "Изменить ширину колонки",
  table_actions: "Действия",
  table_no_sort_applied: "Сортировка не применена",
  table_density: "Плотность строк",
  table_density_comfortable: "Свободно",
  table_density_compact: "Компактно",
  table_density_condensed: "Плотно",
  filter_op_contains: "содержит",
  filter_op_does_not_contain: "не содержит",
  filter_op_is_empty: "пусто",
  filter_op_is_not_empty: "не пусто",
  filter_op_is: "равно",
  filter_op_is_not: "не равно",
  filter_op_is_any_of: "одно из",
  filter_op_is_none_of: "ни одно из",
  filter_op_has_any: "имеет любое",
  filter_op_has_all: "имеет все",
  filter_op_has_none: "не имеет",
  filter_op_before: "до",
  filter_op_after: "после",
  filter_op_between: "между",
  filter_op_last_n_days: "за N дней",
  filter_op_equals: "равно",
  ...
  providers_no_doctors: "У этого провайдера нет врачей",
  ...
  providers_contact_position: "Должность / роль",
  ...
  providers_no_contacts: "Контакты пока не добавлены.",
  ...
  appointments_report_billing_sync: "Синхронизация с бухгалтерией",
  ...
  appointments_billing_sync_pending:
    "Согласовано, синхронизация в бухгалтерию ожидается",
  appointments_billing_sync_none:
    "Статус синхронизации в бухгалтерию ещё не установлен",
  ...
  settings_agency_principal_birth_date: "Дата рождения ответственного лица",
  ...
  activity_subtitle: "Важные действия, изменения данных и события безопасности",
  ...
  activity_action_login_success: "Успешный вход",
  activity_action_login_failure: "Неудачная попытка входа",
  activity_action_login_blocked: "Вход заблокирован",
  activity_action_login_mfa_requested: "Запрошено подтверждение входа",
  activity_action_refresh_family_revoked: "Сессия уже отозвана",
  activity_action_preview_medication_evidence_review: "Открыт предпросмотр пакета доказательств",
  activity_action_create_medication_evidence_review: "Создан пакет доказательств",
  activity_action_read_medication_evidence_review: "Открыт пакет доказательств",
  activity_action_medication_evidence_review_created: "Пакет доказательств создан",
  activity_action_create_medication_ai_analysis: "Запрошен AI-черновик",
  activity_action_read_medication_ai_analysis: "Открыт AI-черновик",
  activity_action_retry_medication_ai_analysis: "Повторно запущен AI-черновик",
  activity_action_medication_ai_analysis_requested: "AI-черновик поставлен в очередь",
  activity_action_medication_ai_analysis_ready: "AI-черновик готов",
  activity_action_medication_ai_analysis_failed: "AI-черновик не сформирован",
  activity_anonymous_actor: "Неавторизованный запрос",
  activity_view_activity: "Действия",
  activity_view_security: "Безопасность",
  activity_view_technical: "Технические",
  activity_view_activity_hint: "Только реальные действия пользователей и изменения данных — без фоновых запросов.",
  activity_view_security_hint: "Входы, управление сессиями, MFA и другие события безопасности.",
  activity_view_technical_hint: "Сырые HTTP-запросы для диагностики. Они автоматически удаляются по короткой политике хранения.",
  activity_view_access: "Доступ и роли",
  activity_view_access_hint: "Создание и блокировка аккаунтов, смена ролей, сброс паролей и 2FA, изменения матрицы доступа и индивидуальных прав.",
  activity_metric_events_24h: "Действий за 24 часа",
  activity_metric_users_24h: "Активных пользователей",
  activity_metric_changes_24h: "Изменений данных",
  activity_metric_security_24h: "Событий безопасности",
  activity_retention: "Автоочистка",
  activity_retention_technical: "технические",
  activity_retention_meaningful: "основные",
  activity_http_request: "Технический запрос",
  activity_entity_http: "API",
  activity_search_placeholder: "Пользователь, действие, объект или ID...",
  activity_no_events: "По выбранным условиям событий нет.",
  activity_technical_route: "Маршрут",
  activity_technical_status: "Статус",
  activity_technical_latency: "Время ответа",
  common_ip: "IP",
  ...
  compliance_patient_id_uuid: "ID пациента (UUID)",
  ...
  compliance_impact_summary: "Сводка влияния",
  ...
  compliance_request_type_access: "Запрос на доступ к данным (ст. 15)",
  compliance_request_type_rectification: "Исправление данных (ст. 16)",
  compliance_request_type_portability: "Перенос данных (ст. 20)",
  compliance_request_type_objection: "Возражение против обработки (ст. 21)",
  compliance_steps_title: "Шаги обработки (ст. 12 DSGVO)",
  compliance_steps_identity: "Личность заявителя",
  compliance_steps_identity_confirm: "Отметить как проверенную",
  compliance_steps_extension: "Продление срока",
  compliance_steps_extension_hint: "один раз на два месяца, только с обоснованием",
  compliance_steps_extension_reason: "Обоснование для заявителя",
  compliance_steps_extension_confirm: "Продлить срок",
  compliance_steps_notified: "Заявитель уведомлён",
  compliance_steps_notified_confirm: "Отметить уведомление",
  compliance_steps_done: "выполнено",
  compliance_steps_open: "не выполнено",
  compliance_steps_method_id_document: "Документ, удостоверяющий личность",
  compliance_steps_method_callback: "Обратный звонок на известный номер",
  compliance_steps_method_signed_letter: "Подписанное письмо",
  compliance_steps_method_in_person: "Лично",
  compliance_steps_method_portal_login: "Вход в портал",
  compliance_steps_channel_email: "E-mail",
  compliance_steps_channel_portal: "Портал",
  compliance_steps_channel_postal_mail: "Почта",
  compliance_steps_channel_phone: "Телефон",
  compliance_steps_channel_in_person: "Лично",
  compliance_steps_recipients: "Получатели уведомлены (ст. 19)",
  compliance_steps_recipients_hint: "уведомить клиники и других получателей об исправлении, удалении или ограничении",
  compliance_steps_recipients_note: "Кто был уведомлён?",
  compliance_steps_recipients_confirm: "Отметить уведомление получателей",
  ...
  invoices_workspace_access_denied: "Счета доступны только CEO, ассистенту CEO, пациент-менеджерам и бухгалтерии.",
  invoices_workspace_kicker: "Рабочее пространство бухгалтерии",
  invoices_workspace_description: "Авансовые, промежуточные и финальные счета, создаваемые из живых снимков предложений.",
  invoices_workspace_refresh: "Обновить",
  invoices_workspace_new_invoice: "Новый счёт",
  invoices_workspace_gross_total: "Итого брутто",
  invoices_workspace_gross_total_description: "Текущий видимый объём счетов",
  invoices_workspace_open_balance: "Открытый баланс",
  invoices_workspace_open_balance_description: "Оставшаяся к оплате сумма",
  ...
  invoices_workspace_cash_expense: "Денежные расходы",
  invoices_workspace_euer_surplus: "Профицит EÜR",
  invoices_workspace_cost_passthrough_revenue: "Выручка по проходным расходам",
  invoices_workspace_no_accounting_entries: "Нет бухгалтерских записей",
  invoices_workspace_no_accounting_entries_description: "Когда счета будут оплачены или внешние инвойсы будут погашены, здесь появятся строки денежного реестра.",
  invoices_workspace_no_order: "Без заказа",
  ...
  invoices_workspace_surplus: "Профицит",
  invoices_workspace_search_placeholder: "Поиск по счёту, предложению, заказу или пациенту",
  invoices_workspace_all_orders: "Все заказы",
  invoices_workspace_all_quotes: "Все предложения",
  invoices_workspace_empty_invoices_description: "Создайте первый счёт из живого снимка предложения.",
  invoices_workspace_balance: "Баланс",
  invoices_workspace_page_label: "Страница",
  invoices_workspace_invoice_count: "счетов",
  invoices_workspace_previous: "Назад",
  invoices_workspace_next: "Далее",
  invoices_workspace_create_invoice_description: "Создайте авансовый, промежуточный или финальный счёт из снимка предложения.",
  invoices_workspace_selected_quote_snapshot: "Выбранный снимок предложения",
  invoices_workspace_choose_quote: "Выберите предложение",
  invoices_workspace_notes: "Заметки",
  invoices_workspace_billing_note_placeholder: "Примечание для бухгалтерии или инструкция по оплате",
  invoices_workspace_detail_sheet_description: "Суммы, статус оплаты и снимок позиций для выбранного счёта.",
  invoices_workspace_no_invoice_selected: "Счёт не выбран",
  invoices_workspace_no_invoice_selected_description: "Выберите карточку счёта, чтобы открыть рабочее пространство бухгалтерии.",
  invoices_workspace_invoice_overview: "Обзор счёта",
  invoices_workspace_invoice_overview_description: "Коммерческие итоги и связанный контекст предложения/заказа.",
  invoices_workspace_preview_pdf: "Предпросмотр PDF",
  invoices_workspace_download_pdf: "Скачать PDF",
  invoices_workspace_balance_due: "К оплате",
  invoices_workspace_linked_context_description: "Быстрый переход к пациенту, заказу, предложению или документам в контексте текущего счёта.",
  invoices_workspace_quotes: "Предложения",
  invoices_workspace_documents: "Документы",
  invoices_workspace_save_invoice: "Сохранить счёт",
  invoices_workspace_dunning_title: "Напоминания об оплате",
  invoices_workspace_dunning_description: "История напоминаний об оплате и передачи задолженности на взыскание.",
  invoices_workspace_dunning_history: "История напоминаний",
  invoices_workspace_dunning_action: "Следующий шаг",
  invoices_workspace_dunning_sent_at: "Дата",
  ...
  invoices_workspace_dunning_missing_due_date: "Укажите срок оплаты счёта, чтобы определить просрочку.",
  invoices_workspace_dunning_not_overdue: "Срок оплаты ещё не истёк. Напоминание доступно со следующего дня после срока оплаты.",
  invoices_workspace_dunning_changed: "История напоминаний изменилась. Обновите счёт, чтобы увидеть следующий доступный шаг.",
  invoices_workspace_dunning_save_error: "Не удалось добавить запись. Обновите счёт и проверьте историю перед повторной попыткой.",
  invoices_workspace_no_dunning_events: "Нет событий по просрочке",
  invoices_workspace_no_dunning_events_description: "Как только счёт станет просроченным, бухгалтерия сможет запустить здесь первое напоминание.",
  invoices_workspace_next_escalation: "Контроль оплаты",
  invoices_workspace_completed: "Завершено",
  invoices_workspace_balance_prefix: "Баланс",
  invoices_workspace_dunning_note: "Внутреннее примечание",
  invoices_workspace_dunning_placeholder: "Запись для бухгалтерии; не отправляется клиенту",
  invoices_workspace_no_further_escalation: "Все шаги уже зарегистрированы",
  invoices_workspace_line_items: "Позиции",
  invoices_workspace_line_items_description: "Снимок счёта в момент создания.",
  invoices_workspace_no_line_items: "Нет позиций",
  invoices_workspace_no_line_items_description: "В этом счёте пока нет материализованных позиций.",
  invoices_workspace_quantity: "Кол-во",
  invoices_workspace_unit: "Единица",
  invoices_workspace_supporting_documents: "Подтверждающие документы",
  invoices_workspace_supporting_documents_description: "Чеки и счета провайдеров, связанные со строками проходных расходов.",
  invoices_workspace_no_supporting_documents: "Нет подтверждающих документов",
  invoices_workspace_no_supporting_documents_description: "В этом счёте нет связанных чеков или счетов провайдера.",
  invoices_workspace_linked_order_document: "Связанный документ заказа",
  invoices_workspace_open_documents: "Открыть документы",
  invoices_workspace_popup_blocked: "Разрешите всплывающие окна для открытия PDF счёта.",
  invoices_workspace_pdf_open_error: "Не удалось открыть PDF счёта.",
  invoices_workspace_pdf_download_error: "Не удалось скачать PDF счёта.",
  invoices_workspace_system: "Система",
  invoices_workspace_status_draft: "Черновик",
  invoices_workspace_status_sent: "Отправлен",
  invoices_workspace_status_partially_paid: "Частично оплачен",
  invoices_workspace_status_paid: "Оплачен",
  invoices_workspace_status_overdue: "Просрочен",
  invoices_workspace_status_cancelled: "Отменён",
  ...
  invoices_workspace_stats_paid_word: "\u043E\u043F\u043B\u0430\u0447\u0435\u043D\u043E",
  invoices_workspace_page_of: "\u0438\u0437",
  invoices_workspace_linked_order: "\u0417\u0430\u043A\u0430\u0437",
  invoices_workspace_send_dunning: "\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C: {level}",
  ...
  documents_source_clinical_import: "Импорт медицинского документа",
  ...
  documents_share_provider_context_hint:
    "Выберите провайдера, который привязан к заказу или приёму этого документа.",
  documents_share_provider_context_empty:
    "Для этого документа нет подходящего провайдера в заказе или приёме. Сначала привяжите корректного провайдера к заказу или приёму.",
  ...
  documents_share_provider_specialty_mismatch:
    "Специализация выбранного провайдера не совпадает с медицинским контекстом документа. Выберите провайдера нужной специализации или обновите специализацию/контекст приёма.",
  documents_share_external_release_required:
    "Перед публикацией провайдеру документ должен быть выпущен для внешнего доступа. Сначала переведите документ в статус внешнего релиза.",
  documents_share_provider_channel_fix:
    "Чтобы использовать этот канал, добавьте соответствующий официальный контакт в профиль провайдера или выберите уже зарегистрированный канал.",
  documents_share_open_order_services: "Открыть услуги заказа",
  documents_share_open_appointment: "Открыть приём",
  ...
  documents_machine_translation_draft: "Черновик перевода (локальная модель)",
  ...
  services_error_create: "Не удалось создать сервисный запрос.",
  services_notice_cancelled: "Сервисный запрос отменен.",
  services_error_cancel: "Не удалось отменить сервисный запрос.",
  ...
  services_vendor: "Поставщик",
  services_estimate: "Оценка",
  services_booking_reference: "Референс бронирования",
  services_created_at: "Создано",
  ...
  services_type_flight: "Перелет",
  services_type_chauffeur: "Шофер",
  services_type_translation_support: "Языковая поддержка",
  services_type_other: "Другое",
  services_form_title: "Название",
  services_form_title_placeholder: "Отель у аэропорта",
  services_form_preferred_vendor: "Предпочтительный поставщик",
  services_form_preferred_vendor_placeholder:
    "Отель / авиакомпания / трансферная компания",
  services_form_vendor_contact: "Контакт поставщика",
  services_form_vendor_contact_placeholder:
    "Почта или телефон для бронирования",
  services_form_budget: "Ориентировочный бюджет (EUR)",
  services_form_notes: "Заметки",
  services_form_notes_placeholder:
    "Детали прибытия, багаж, предпочтения по отелю, контекст VIP...",
  services_submit: "Отправить запрос",
  chat_title: "Чат",
