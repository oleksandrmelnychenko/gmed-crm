...
export const ru = {
  ...
  nav_sales_people: "CV-библиотека",
  ...
  sales_people_title: "CV-библиотека",
  sales_people_subtitle:
    "Табличный реестр профилей для продаж с раскрываемым деревом CV по каждому человеку.",
  sales_people_search_placeholder: "Поиск по имени, рынку, языку или владельцу",
  sales_people_status_all: "Все статусы",
  sales_people_table_person: "Человек",
  sales_people_table_role: "Профиль",
  sales_people_table_location: "Локация",
  sales_people_table_languages: "Языки",
  sales_people_table_owner: "Владелец",
  sales_people_table_updated: "Обновлен",
  sales_people_table_status: "Статус",
  sales_people_empty_title: "CV не найдены",
  sales_people_empty_description:
    "Измените поиск или фильтр статуса, чтобы вернуть записи в таблицу.",
  sales_people_expand_cv: "Раскрыть CV",
  sales_people_collapse_cv: "Свернуть CV",
  sales_people_tree_expand: "Раскрыть ветку",
  sales_people_tree_collapse: "Свернуть ветку",
  sales_people_cv_tree: "Дерево CV",
  sales_people_stat_total: "Всего CV",
  sales_people_stat_ready: "Готовы",
  sales_people_stat_review: "На проверке",
  sales_people_stat_cities: "Локации",
  sales_people_status_ready: "Готов",
  sales_people_status_review: "Проверка",
  sales_people_status_draft: "Черновик",
  sales_people_status_archived: "Архив",
  ...
  invoices_workspace_access_denied: "Счета доступны только CEO, ассистенту CEO, пациент-менеджерам и биллингу.",
  invoices_workspace_kicker: "Рабочее пространство биллинга",
  ...
  invoices_workspace_billing_note_placeholder: "Примечание для биллинга или инструкция по оплате",
  ...
  invoices_workspace_no_invoice_selected_description: "Выберите карточку счёта, чтобы открыть рабочее пространство биллинга.",
  ...
  invoices_workspace_no_dunning_events_description: "Как только счёт станет просроченным, биллинг сможет запустить здесь первое напоминание.",
  ...
  invoices_workspace_dunning_placeholder: "Текст напоминания или внутренняя заметка биллинга",
