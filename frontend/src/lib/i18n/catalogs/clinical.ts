...
export const clinicalRu: ClinicalTranslations = {
  ...
  appointment_interpreter_response_accepted: "Подтверждено",
  ...
  appointments_external_handoff_description: "Журнал внешней коммуникации с клиниками, врачами и поставщиками услуг, а также внутреннее сопровождение.",
  ...
  appointments_external_handoff_internal_trail: "Внутреннее сопровождение",
  ...
  appointments_follow_up_visit_title: "Планирование контрольного визита",
  ...
  appointments_follow_up_visit_created: "Контрольный визит создан.",
  appointments_follow_up_visit_create_reminder: "Создать подготовительное напоминание для нового контрольного визита.",
  appointments_follow_up_visit_create: "Создать контрольный визит",
  appointments_follow_up_visit_reminder_title: "Подготовить контрольный визит: {title}",
  appointments_follow_up_visit_reminder_description:
    "Запланировано из приёма {patientPid} · {title} · {slot}.",
  appointments_handoff_title: "Передача и сопровождение",
  ...
  appointments_package_follow_up_title: "Сопровождение по окончанию пакета",
  ...
  appointments_doctor_follow_up_create: "Создать контроль по назначению врача",
...
export const clinicalDe: ClinicalTranslations = {
  ...
  appointment_interpreter_response_accepted: "Bestätigt",
  ...
  appointment_billing_handoff_kind_provider_invoice: "Anbieterrechnung",
  ...
  appointments_external_handoff_title: "Klinik- und Arztübergabe",
  ...
  appointments_follow_up_visit_title: "Nachsorgetermin planen",
  ...
  appointments_follow_up_visit_created: "Nachsorgetermin erstellt.",
  appointments_follow_up_visit_create_reminder: "Vorbereitungserinnerung für den neuen Nachsorgetermin erstellen.",
  appointments_follow_up_visit_create: "Nachsorgetermin erstellen",
  appointments_follow_up_visit_reminder_title: "Nachsorgetermin vorbereiten: {title}",
  appointments_follow_up_visit_reminder_description:
    "Geplant aus Termin {patientPid} · {title} · {slot}.",
  appointments_handoff_title: "Übergabe und Nachsorge",
  ...
  appointments_package_follow_up_create_task: "Verknüpfte Aufgabe für die Nachsorge zum Paketende erstellen.",
  ...
  appointments_doctor_follow_up_create: "Ärztliche Nachsorge erstellen",
