...
export const textareaBaseClassName =
  "min-h-[80px] w-full rounded-lg border border-input bg-field px-3 py-2 text-sm leading-relaxed text-foreground outline-none transition focus:border-ring focus:ring-2 focus:ring-ring/30";
