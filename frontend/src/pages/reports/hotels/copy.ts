export const hotelCopy = {
  ru: {
    ...
    breakfastTerms: "Условия завтрака", breakfastTermsUnknown: "Не указаны", breakfastTermsIncluded: "Включён", breakfastTermsExtra: "За доплату", breakfastTermsUnavailable: "Не предоставляется", breakfastPerPerson: "за человека",
  ...
  de: {
    ...
    breakfastTerms: "Frühstückskonditionen", breakfastTermsUnknown: "Nicht erfasst", breakfastTermsIncluded: "Inklusive", breakfastTermsExtra: "Gegen Aufpreis", breakfastTermsUnavailable: "Nicht angeboten", breakfastPerPerson: "pro Person",
