...
export function datevSetupBrief(profile: DatevProfile) {
  ...
  return [
    ...
    "",
    "Verbindungsstatus: Diese Checkliste enthält nur Profilangaben. Den aktuellen Verbindungs- und Prüfstatus in GMed unter Administration / DATEV prüfen. Das Speichern dieses Profils erteilt keine Zugriffsrechte.",
    "In GMed implementiert: Abruf von Wirtschaftsjahren, Zahlungsbedingungen sowie Summen und Salden; benötigt App-Zugangsdaten und DATEV-Berechtigungen. PDF/XML-Dateien können manuell importiert werden. Keine Originalbelege automatisch abrufen, keine Belege hochladen, keine Buchungen ändern, keine Rechnungen freigeben und keine Zahlungen auslösen.",
    "",
