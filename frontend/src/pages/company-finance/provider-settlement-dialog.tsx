...
const copy = {
  ru: {
    title: "Расчеты с поставщиком",
    description: "Частичные и полные выплаты по счету поставщика",
    invoiceAmount: "Сумма счета",
    paid: "Выплачено компанией",
    remaining: "Осталось выплатить",
    payment: "Новая выплата",
    ...
    cancel: "Не отменять",
    noAccount: "Нет активного счета компании в этой валюте.",
    approveFirst: "Сначала подтвердите счет поставщика в заказе.",
    paidInFull: "Обязательство перед поставщиком полностью погашено.",
    loadFailed: "Не удалось загрузить историю расчетов.",
  ...
  de: {
    ...
    approveFirst: "Die Eingangsrechnung muss zuerst im Auftrag freigegeben werden.",
    paidInFull: "Die Verbindlichkeit gegenüber dem Leistungserbringer ist vollständig beglichen.",
    loadFailed: "Der Zahlungsverlauf konnte nicht geladen werden.",
