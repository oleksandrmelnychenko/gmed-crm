...
export const appointmentElevatedSectionCardClassName =
  "rounded-lg border border-slate-200/80 bg-white p-5 shadow-[0_20px_50px_-35px_rgba(15,23,42,0.35)]";
...
export const appointmentSoftRowClassName =
  "rounded-lg border border-slate-200/80 bg-slate-50/80 px-4 py-3";
...
export const appointmentSoftSplitRowClassName =
  "flex flex-col gap-3 rounded-lg border border-slate-200/80 bg-slate-50/80 px-4 py-3 md:flex-row md:items-center md:justify-between";
