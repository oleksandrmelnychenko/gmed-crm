...
export const DARREICHUNGSFORM_OPTIONS: readonly MedicationOption[] = [
  ...
  { value: "EDAT", label: "EDAT — Augentropfen (Einzeldosis)" },
  { value: "EDGL", label: "EDGL — Augengel (Einzeldosis)" },
  { value: "EMUL", label: "EMUL — Emulsion (Haut)" },
  { value: "EMULE", label: "EMULE — Emulsion zum Einnehmen" },
  ...
  { value: "GRAM", label: "GRAM — magensaftresistentes Granulat" },
  { value: "GRAN", label: "GRAN — Granulat" },
  { value: "IFIJ", label: "IFIJ — Injektions-/Infusionslösung" },
  { value: "IFLG", label: "IFLG — Infusionslösung" },
  { value: "IJLG", label: "IJLG — Injektionslösung" },
  { value: "IJSU", label: "IJSU — Injektionssuspension" },
  { value: "INHK", label: "INHK — Hartkapseln zur Inhalation" },
  { value: "INHL", label: "INHL — Lösung zur Inhalation" },
  { value: "INHP", label: "INHP — Pulver zur Inhalation" },
  { value: "KAPM", label: "KAPM — magensaftresistente Kapseln" },
  { value: "KAPR", label: "KAPR — Retardkapseln" },
  { value: "KAPS", label: "KAPS — Kapseln" },
  { value: "KGUM", label: "KGUM — Kaugummis" },
  { value: "KOMB", label: "KOMB — Kombipackung" },
  { value: "KTAB", label: "KTAB — Kautabletten" },
  { value: "LOTI", label: "LOTI — Lotion (Emulsion Haut)" },
  ...
  { value: "PAST", label: "PAST — Paste (Haut)" },
  { value: "PFLA", label: "PFLA — transdermale Pflaster" },
  { value: "PLVD", label: "PLVD — Pulver zur Inhalation (einzeldosiert)" },
  { value: "PSTI", label: "PSTI — Pastillen / Lutschpastillen" },
  { value: "PULV", label: "PULV — Pulver (zur Herstellung)" },
  { value: "PULVE", label: "PULVE — Pulver zum Einnehmen" },
  ...
  { value: "SALB", label: "SALB — Salbe" },
  { value: "SCHAU", label: "SCHAU — Schaum (Haut)" },
  { value: "SIRP", label: "SIRP — Sirup" },
  { value: "SPRY", label: "SPRY — Spray (Mundhöhle)" },
  { value: "STABL", label: "STABL — Schmelztabletten" },
  { value: "STIF", label: "STIF — Stifte (Haut)" },
  ...
  { value: "TABMD", label: "TABMD — Tabletten m. veränderter Freisetzung" },
  ...
  { value: "TTAB", label: "TTAB — Tabletten f. Lösung/Suspension" },
